...
<head>
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="../theme3/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<link rel="stylesheet" href="../theme3/css/icomoon.css">
	<!-- Bootstrap  -->
	<link rel="stylesheet" href="../theme3/css/bootstrap.css">
	<!-- Superfish -->
	<link rel="stylesheet" href="../theme3/css/superfish.css">
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="../theme3/css/magnific-popup.css">

	<link rel="stylesheet" href="../theme3/css/style.css">


	<!-- Modernizr JS -->
	<script src="../theme3/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
...
<body>
	...
	<!-- jQuery -->
	<script src="../theme3/dist/scripts.min.js"></script>
</body>
